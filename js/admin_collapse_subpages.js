	...
	function initial_collapse_work(){
		...
		jQuery('.pages #the-list tr').each(function(){
			...
			if(jQuery('#the-list').find('[data-parent="' + id + '"]').size() > 0)
				jQuery(this).find('.page-title strong').append('<span class="expand_link"><a href="javascript:void(0);" class="button minus"><span class="screen-reader-text">' + acs_strings.children + '</span></a></span>');
		});
